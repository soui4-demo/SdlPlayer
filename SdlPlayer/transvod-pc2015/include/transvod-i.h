...
DECLARE_INTERFACE(ITransVodListener) {
    ...
    STDMETHOD_(void,onP2PShareStats)(THIS_ int32_t shareUpStreamFlow, int32_t shareDownStreamFlow, int32_t serverDownStreamFlow) PURE;
    STDMETHOD_(void,onP2PJsonContent)(THIS_ int32_t cbKey, const char* json) PURE;
...
DECLARE_INTERFACE_(ITransVod, IUnknown) {
    ...
    STDMETHOD_(BOOL, setVideoBuiltinRender)
    (THIS_ const VideoRenderConfig* cfg, 
     const RenderRectParam* rect) PURE;

    STDMETHOD_(BOOL, setAudioBuiltinRender)
    (THIS_ const AudioDeviceParam* param,
    double volumePercent) PURE;

    STDMETHOD_(BOOL, changeAudioDevice)(THIS_ const AudioDeviceParam* param)PURE;
    ...
    STDMETHOD_(void, setP2pAppId)(THIS_ LPCSTR pszAppId) PURE;
    STDMETHOD_(void, setP2pAccountInfo)(THIS_ uint32_t netState, uint64_t imsi, LPCSTR manufacture, LPCSTR model) PURE;
    STDMETHOD_(void, setP2pParameter)(THIS_ LPCSTR pszParams) PURE;
    ...
    STDMETHOD_(void, setVolume)(THIS_ double volPercent) PURE;
    ...
    STDMETHOD_(void, seekTo)(THIS_ float position) PURE;
    ...
    STDMETHOD_(void, enableVideoOutputFilter)(THIS_ BOOL enable) PURE;
